            ...
            <form action="{{ route('tareas.update',$tarea->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="columns">
                    ...
                    <div class="column">
                        ...
                        <input type="date" value="{{ old('fecha_crea', $tarea->fecha_crea) }}" name="fecha_crea" placeholder="Fecha de Creación" class="input"><br>
                        <label class="label">Fecha de Realización</label>
                        <input type="date" value="{{ old('fecha_rea', $tarea->fecha_rea) }}" name="fecha_rea" placeholder="Pais" class="input"><br>
