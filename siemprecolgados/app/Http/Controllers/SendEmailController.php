...
{
    public static function sendEmail($cliente,$request){        
        ...
        $data["importe"] = $data['eur'][strtolower($cliente->moneda)]*$request->importe;
        $data["importeiva"] = ($data['eur'][strtolower($cliente->moneda)]*$request->importe)*1.21;
